...
# ================================================================================
Write-TSGSection "ACCESS CONTROL (AC)" "CMMC AC.L1-3.1.1 to AC.L1-3.1.22 | CPCSC A.03.01"
...
Write-Host "    [INFO] CM.L2-3.4.1/2 | CPCSC A.03.04.01/02 -- This script is the baseline configuration" -ForegroundColor DarkYellow
...
# CMMC: CM.L2-3.4.6 / SC.L1-3.13.1 | CPCSC: A.03.04.06 / A.03.13.01
...
# CMMC: CM.L2-3.4.7 / SI.L1-3.14.2 | CPCSC: A.03.04.07 / A.03.14.02
$officeVersion = "16.0"
...
Write-Host "    [OK] SI.L1-3.14.2 | CPCSC A.03.14.02 -- Office macros from internet blocked" -ForegroundColor Green
...
# CMMC: SC.L2-3.13.11 | CMMC Level 2 | CPCSC: A.03.13.11
...
Write-Host "    [OK] SC.L2-3.13.11 | CPCSC A.03.13.11 -- FIPS-validated cryptography enabled (restart required)" -ForegroundColor Green
...
Write-Host "    [NOTE] SC.L2-3.13.16 | CPCSC A.03.13.16 -- Restart required to complete encryption" -ForegroundColor Yellow
...
Write-Host "    [OK] SC.L1-3.13.1 | CPCSC A.03.13.01 -- Activity history and ad upload disabled" -ForegroundColor Green
...
Write-Host "    [OK] SI.L1-3.14.2 | CPCSC A.03.14.02 -- ASLR and forced relocation" -ForegroundColor Green
...
Write-Host "    [OK] SI.L1-3.14.2 | CPCSC A.03.14.02 -- SEHOP enabled" -ForegroundColor Green
