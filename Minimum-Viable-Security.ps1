...
Write-Host "  Minimum Viable Security" -ForegroundColor DarkYellow
Write-Host "  High-impact, low-disruption controls for any Windows system" -ForegroundColor Gray
...
# Source: DISA WNFWA-000010/015/020 | CIS 9.1.1/9.2.1/9.3.1 | CCCS ITSP.70.012
...
Write-TSGSection "TELEMETRY" "DISA WN11-CC-000205 | CCCS | NSA/CISA | PIPEDA"
...
Write-Host ""
Write-Host "  Minimum Viable Security baseline applied." -ForegroundColor DarkYellow
