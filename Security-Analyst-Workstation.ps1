...
Write-Host "  Security Analyst Workstation Hardening" -ForegroundColor DarkYellow
Write-Host "  SOC / Threat Hunt / DFIR -- DISA STIG + analyst carve-outs" -ForegroundColor Gray
...
# Source: DISA WN11-SO-000195 | CIS 2.3.11.6 | CCCS ITSP.70.012
...
# Source: DISA WN11-SO-000205 | CIS 2.3.11.7 | CCCS ITSP.70.012
...
# Source: DISA WNFWA-000010/015/020/025/030/035 | CIS 9.x | CCCS ITSP.70.012
...
# Source: DISA WN11-AU-000050 (auditpol) | WN11-CC-000066 (registry) | NSA/CISA | CCCS ITSP.70.012
...
# Source: DISA WN11-CC-000326 | NSA/CISA June 2022 CSI | CCCS ITSP.70.012
...
# SEHOP -- value 0 ENABLES it (counterintuitive name, confirmed in DISA WN11-00-000150)
# Source: DISA WN11-00-000150 | CIS | CCCS ITSP.70.012
...
Write-Host ""
Write-Host "  Security Analyst workstation hardening complete." -ForegroundColor DarkYellow
