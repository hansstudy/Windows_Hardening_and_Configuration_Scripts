...
Write-Host "  CCCS / NSA / CISA Hardening Baseline" -ForegroundColor DarkYellow
Write-Host "  CSE/CCCS ITSP.70.012 + NSA/CISA guidance" -ForegroundColor Gray
...
# ════════════════════════════════════════════════════════════════════════════════
Write-TSGSection "CREDENTIAL AND IDENTITY PROTECTION" "CCCS ITSP.70.012 | DISA WN11-CC-000038/SO-000100/195"
...
# ════════════════════════════════════════════════════════════════════════════════
Write-TSGSection "TELEMETRY AND PRIVACY" "DISA WN11-CC-000205/225 | CIS 18.9.16/44/46 | CCCS ITSP.70.012"

# Disable DiagTrack (telemetry service)
# Source: DISA WN11-CC-000205 | CIS 18.9.16.1 | CCCS ITSP.70.012
...
Write-Host ""
Write-Host "  CCCS / NSA / CISA baseline applied." -ForegroundColor DarkYellow
